...
- (void)createUI{    
    ...
    self.actionSheetHeight = (dataArray.count + temp)* cellHeight + margin +20;
    ...
    actionSheetTableView.backgroundColor = LKLightGrayColor;
//    actionSheetTableView.alpha = 0.98;
    actionSheetTableView.separatorColor = LKF7Color;
...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section{
    if (section == 1) {
        UIImageView *fenGeImageView = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, kScreen_Width, margin)];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (indexPath.section == 1) {
        ...
        [button setTitleColor:LKRedColor forState:UIControlStateNormal];
