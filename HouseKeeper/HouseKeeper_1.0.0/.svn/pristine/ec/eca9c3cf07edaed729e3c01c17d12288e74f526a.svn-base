...
@property (nonatomic, strong) UIColor * _Nullable tintColor; //主色色调
@property (nonatomic, weak)   UIViewController * _Nullable viewController; //是否显示在ViewController上，为空时显示在Window上
@property (nonatomic, readonly, weak) UIView * _Nullable targetView; //指定显示在某个View上
//MaskView
 ...
 * 设置目标显示视图，并传入HUD显示位置
 */
- (void)setTargetView:(UIView *_Nullable)targetView position:(CGPoint)position;
