...
@interface LKAddPicturePlaceholderView ()
@property (nonatomic, strong) UIImageView *cameraImageView;
@property (nonatomic, strong) UILabel *tipLabel;
@end

@implementation LKAddPicturePlaceholderView

- (void)createUI {
    [super createUI];
    self.placeholderViewWidth = (kScreen_Width - 110 )/3.0f - 8;
...
//    }else {
    self.tipLabel.text = [NSString stringWithFormat:@"%ld/9",(long)(9-_index)];
//    }
}
...
- (UIImageView *)cameraImageView {
    if (_cameraImageView == nil) {
        ...
        _cameraImageView.image = [UIImage imageNamed:@"notes_icon_camera"];
    }
