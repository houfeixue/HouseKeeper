...
-(UILabel *)authorLabel{
    if (_authorLabel == nil) {
        ...
        if ([self.authorType isEqualToString:@"1"]) {
            _authorLabel.attributedText = [NSString getAttributeStringWithLabelText:@"提交成功" font:LK_medium_20font textColor:[UIColor colorWithRed:51/255.0 green:51/255.0 blue:51/255.0 alpha:1/1.0] changeText:@"\n\n您的申请正在审核请耐心等待" changeFont:LK_16font changeColor: [UIColor colorWithRed:51/255.0 green:51/255.0 blue:51/255.0 alpha:1/1.0]];
        }else if ([self.authorType isEqualToString:@"2"]){
           _authorLabel.attributedText = [NSString getAttributeStringWithLabelText:@"审核失败" font:LK_medium_20font textColor:[UIColor colorWithRed:51/255.0 green:51/255.0 blue:51/255.0 alpha:1/1.0] changeText:@"\n\n您输入的信息有误，请重新认证" changeFont:LK_16font changeColor: [UIColor colorWithRed:51/255.0 green:51/255.0 blue:51/255.0 alpha:1/1.0]];
        }
    }
    return _authorLabel;
}
