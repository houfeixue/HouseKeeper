...
//    LKSpotcheckcountImages;
    ...
    [self.lookViewModel.cellClickSubject subscribeNext:^(id  _Nullable x) {
        ...
        if ([x isKindOfClass:[NSString class]]) {
            ...
            NSDictionary * paramdict = (NSDictionary *)x;
...
//            if ([type isEqualToString:@"AllCount"]) {
//                NSNumber * allcount = [dict objectForKey:@"count"];
//                BOOL hasNOData = [allcount intValue] == 0 ? YES : NO;
//            }
