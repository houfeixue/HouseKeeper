...
@interface LKQualityReportHeaderView ()

@end

@implementation LKQualityReportHeaderView
...
- (void)bindDataIconImage:(NSString *)iconImage titleName:(NSString *)titleName score:(NSNumber *)score {
...
-(UIButton *)flitBtn{
    if (_flitBtn == nil) {
        ...
        [_flitBtn setTitle:@"展开" forState:UIControlStateNormal];
