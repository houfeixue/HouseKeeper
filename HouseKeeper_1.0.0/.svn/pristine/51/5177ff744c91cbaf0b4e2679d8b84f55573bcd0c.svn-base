...
- (void)setHeaderTitleTextAlignment:(NSTextAlignment)headerTitleTextAlignment {
    if (!(_headerTitleTextAlignment == headerTitleTextAlignment)) {
        _headerTitleTextAlignment = headerTitleTextAlignment;
        [self.calendar configureAppearance];
    }
}
