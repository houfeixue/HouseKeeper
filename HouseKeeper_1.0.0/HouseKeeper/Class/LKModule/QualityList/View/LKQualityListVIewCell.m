...
- (void)_setupViews
{
    ...
    [self.referenceLabel mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.bottom.equalTo(self.contentView).offset(-17-0);
    ...
    [self.whiteView hyb_addCornerRadius:5];
...
-(void)conFigCellwithData:(id)data atIndex:(NSIndexPath *)indexPath
{
    if ([data isKindOfClass:[LKQualityInfoModel class]]) {
        ...
        self.nameLabel.attributedText = [NSString getAttributeStringWithimage:[UIImage imageNamed:@"line"] imageBounds:CGRectMake(0, -2, 4, 15) withLabelText:[NSString stringWithFormat:@" %@",model.itemName] font:LK_16font textColor: [UIColor colorWithRed:51/255.0 green:51/255.0 blue:51/255.0 alpha:1/1.0]];
...
-(UILabel *)referenceLabel
{
    if (_referenceLabel == nil) {
        ...
        _referenceLabel.font = LK_13font;
        _referenceLabel.textColor = [UIColor colorWithRed:102/255.0 green:102/255.0 blue:102/255.0 alpha:1];
